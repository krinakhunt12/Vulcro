    ...
    <div className="container mx-auto px-6 py-10">
      ...
      {items.length === 0 ? (
        <div className="min-h-[40vh] flex flex-col items-center justify-center gap-6">
          <div className="w-64 h-48 bg-gray-100 rounded-md flex items-center justify-center">{/* illustration placeholder */}
            <svg width="120" height="90" viewBox="0 0 120 90" fill="none"><rect width="120" height="90" rx="8" fill="#F7F7F7"/></svg>
          </div>

          <div className="text-center">
            <h2 className="text-xl font-semibold">Your cart is empty</h2>
            <p className="text-sm text-gray-600 mt-2">Browse our kurti collections and add your favourites.</p>

            <div className="mt-4">
              <Link href="/shop">
                <button className="btn-outline px-4 py-2">Continue Shopping</button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <aside className="lg:col-span-4">
            <div className="card p-6 sticky top-24">
              ...
              <div className="mt-6">
                <Link href="/checkout">
                  <button className="w-full btn-primary px-4 py-3">Proceed to Checkout</button>
                </Link>
              </div>
            </div>
          </aside>
