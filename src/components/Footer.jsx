export default function Footer() {
  return (
    <footer className="mt-16 border-t border-gray-100 py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="text-xl font-bold">VULCRO</div>
            <div className="text-sm text-gray-600 mt-2">Premium traditional kurti sets from Surat.</div>
          </div>
        ...
        <div className="mt-8 text-sm text-gray-500">© {new Date().getFullYear()} VULCRO. All rights reserved.</div>
      </div>
    </footer>
  );
}
