...
export default function AdminLoginPage() {
    ...
    return ( <
            ...
            <
            label htmlFor = "email"
            className = "text-sm text-gray-700" > Email < /label> <
            ...
            /> {
                ...
                className = "text-sm text-gray-700" > Password < /label> <
                ...
                onClick = {
                    () => setShowPassword((s) => !s) }
                className = "absolute right-2 top-2 text-sm text-gray-500" > { showPassword ? 'Hide' : 'Show' } <
                    /button> <
                    /div> {
                        ...
                        className = "text-black underline" > Create an admin account < /Link> <
                            /div> <
                            /div> <
                            /div> <
                            /main> <
